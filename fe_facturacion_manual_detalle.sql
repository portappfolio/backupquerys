...
left join db_cloudcontrol.tbl_brz_cloudtenant ct
  on fe.cloudtenantidmarket = ct.CloudTenantID
where
--b.uso != 'Sin Uso'
...
--b.cohorte_renovacion in ('2023-01-01','2023-02-01','2023-03-01','2023-04-01','2023-05-01','2023-06-01')
--and coalesce(f.`_2023`,0) > 0
--and not nc.hid is null
